<script lang="ts">
    ...
    export let sentimentData: Record<string, { avg_sentiment: number; review_count: number }> = {};
    ...
    const colorRange = ["#f2fbd9", "#c1e7a5", "#7fc97f", "#2e8b57", "#00441b"];
  ...
  const legendMarginTop = 10;
    ...
    function drawMap() {
      ...
      const thresholds = d3.range(minVal, maxVal, (maxVal - minVal) / colorRange.length);
